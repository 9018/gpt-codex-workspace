...
export const GPTWORK_TOOL_CARD_URI = "ui://widget/gptwork-tool-card-v5.html";
...
export const GPTWORK_LEGACY_TOOL_CARD_V2_URI = "ui://widget/gptwork-tool-card-v2.html";
export const GPTWORK_LEGACY_TOOL_CARD_V3_URI = "ui://widget/gptwork-tool-card-v3.html";
export const GPTWORK_LEGACY_TOOL_CARD_V4_URI = "ui://widget/gptwork-tool-card-v4.html";
...
export const GPTWORK_TOOL_CARD_VERSION = "gptwork-tool-card-v5";
