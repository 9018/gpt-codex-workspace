...
import { dispatchTaskProvider } from "./task-provider-dispatcher.mjs";
import { applyLegacyNoChangeCompatibility, normalizeTuiEvidenceToTaskResult } from "./task-result-normalizer.mjs";
import { applyRepairMetadata, taskWithRepairContext } from "./task-repair-context.mjs";
import { parkTaskForHealingRetry, RETRY_HEALING_ACTIONS } from "./task-healing-controller.mjs";
import { verifyRealTaskWorktree } from "./task-worktree-verifier.mjs";
import { applySuccessfulDeliveryRecovery, buildDeliveryResultRecoveryEvidence, recoveryCommandListFromConfig } from "./task-delivery-recovery.mjs";
import { recordAgentRunWritebackFailure } from "./agent-run-writeback-failure.mjs";

export async function runTaskExecution(store, config, task, context, github, deps = {}) {
