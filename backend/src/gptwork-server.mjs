            ...
            try {
              ...
              if (canonPath) {
                ...
                if (!mdExists || !envExists) {
                  actions.push('Run project_context_status for project context health — missing ' + (!mdExists ? 'project.md' : '') + (!mdExists && !envExists ? ' and ' : '') + (!envExists ? 'project.env' : ''));
                }
                ...
                if (envExists) {
                  try {
                    ...
                    if (!envContent) {
                      actions.push('Run project_context_status for project context health — project.env exists but is empty');
                    }
                  } catch (e) {}
                }
              }
