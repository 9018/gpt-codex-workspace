...
export async function createGptWorkServer(options = {}) {
  ...
  const config = {
    ...
    codexContentFirstOutputTimeout: Number(options.codexContentFirstOutputTimeout || rcc.codexContentFirstOutputTimeout || 0),
    codexNoProgressTimeout: Number(options.codexNoProgressTimeout || rcc.codexNoProgressTimeout || 0),
    agentBackend: options.agentBackend || rcc.agentBackend,
    agentRoleBackends: options.agentRoleBackends || rcc.agentRoleBackends,
    agentLocalCommand: options.agentLocalCommand || rcc.agentLocalCommand,
    agentRoleCommands: options.agentRoleCommands || rcc.agentRoleCommands,
    agentCommandTimeout: Number(options.agentCommandTimeout || rcc.agentCommandTimeout || rcc.shellTimeout || 60),
    agentCommandFirstOutputTimeout: Number(options.agentCommandFirstOutputTimeout || rcc.agentCommandFirstOutputTimeout || 0),
    agentCommandNoProgressTimeout: Number(options.agentCommandNoProgressTimeout || rcc.agentCommandNoProgressTimeout || 0),
    agentBackendDefault: options.agentBackendDefault || rcc.agentBackendDefault,
    agentBackendByRole: options.agentBackendByRole || rcc.agentBackendByRole,
    localCommandBackendCommand: options.localCommandBackendCommand || rcc.localCommandBackendCommand,
    localCommandBackendTimeout: Number(options.localCommandBackendTimeout || rcc.localCommandBackendTimeout || rcc.shellTimeout || 60),
