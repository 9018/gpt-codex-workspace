...
export function buildRuntimeConfig(workspaceRoot, overridePath, preloadedKeys = []) {
  ...
  const KEY_MAP = {
    ...
    recoveryPlaneEnabled: "GPTWORK_RECOVERY_PLANE_ENABLED",
    recoveryUnrestrictedLocalCommandEnabled: "GPTWORK_RECOVERY_UNRESTRICTED_LOCAL_COMMAND",
    recoveryAllowedRoots: "GPTWORK_RECOVERY_ALLOWED_ROOTS",
